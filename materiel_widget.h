#ifndef MATERIEL_WIDGET_H
#define MATERIEL_WIDGET_H
...
// ==================== Fenêtre Principale ====================
class MaterielWidget : public QMainWindow
{
    Q_OBJECT

public:
    explicit MaterielWidget(QWidget *parent = nullptr);
    ~MaterielWidget();
...
private:
    ...
    Ui::MaterielWidget *ui;
};

#endif // MATERIEL_WIDGET_H