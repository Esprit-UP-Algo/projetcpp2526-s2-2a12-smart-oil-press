...
{
    // Quick actions
    connect(ui->btnActionAjouter, &QPushButton::clicked, this, &WidgetClient::onActionAjouterClicked);
    connect(ui->btnActionModifier, &QPushButton::clicked, this, &WidgetClient::onActionModifierClicked);
    connect(ui->btnActionSupprimer, &QPushButton::clicked, this, &WidgetClient::onActionSupprrimerClicked);
...
void WidgetClient::onExporterPDFClicked()
{
...
void WidgetClient::onActionAjouterClicked()
{
    showClientDialog(false);
}

void WidgetClient::onActionModifierClicked()
{
...
void WidgetClient::onActionSupprrimerClicked()
{
    if (ui->tableClients->currentRow() == -1) {
        QMessageBox::warning(this, "Attention", 
...
void WidgetClient::showClientDialog(bool isEdit)
{
    QDialog dialog(this);
