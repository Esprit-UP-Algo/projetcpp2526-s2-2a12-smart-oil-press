...
public:
    ...
    QLabel *label_observations_add;
    QPlainTextEdit *plainTextEdit_obs_add;
    QLabel *label_espaceReste_add;
    QLineEdit *lineEdit_espaceReste_add;
    ...
    QLabel *label_espaceReste_modif;
    QLineEdit *lineEdit_espaceReste_modif;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        geoLayout = new QVBoxLayout(tabGeolocalisation);
        geoLayout->setObjectName("geoLayout");
        geoPlaceholder = new QLabel(tabGeolocalisation);
        ...
        aiLayout = new QVBoxLayout(tabAIBot);
        aiLayout->setObjectName("aiLayout");
        aiPlaceholder = new QLabel(tabAIBot);
        ...
        btnExportPDF->setMinimumSize(QSize(0, 36));
        ...
        lineEdit_10 = new QLineEdit(addFormFrame);
        lineEdit_10->setObjectName("lineEdit_10");

        addFormLayout->setWidget(3, QFormLayout::FieldRole, lineEdit_10);

        label_34 = new QLabel(addFormFrame);
        label_34->setObjectName("label_34");

        addFormLayout->setWidget(4, QFormLayout::LabelRole, label_34);

        plainTextEdit_4 = new QPlainTextEdit(addFormFrame);
        plainTextEdit_4->setObjectName("plainTextEdit_4");

        addFormLayout->setWidget(4, QFormLayout::FieldRole, plainTextEdit_4);

        label_41 = new QLabel(addFormFrame);
        label_41->setObjectName("label_41");

        addFormLayout->setWidget(5, QFormLayout::LabelRole, label_41);

        comboBox_13 = new QComboBox(addFormFrame);
        comboBox_13->addItem(QString());
        comboBox_13->addItem(QString());
        comboBox_13->setObjectName("comboBox_13");

        addFormLayout->setWidget(5, QFormLayout::FieldRole, comboBox_13);

        label_observations_add = new QLabel(addFormFrame);
        label_observations_add->setObjectName("label_observations_add");

        addFormLayout->setWidget(6, QFormLayout::LabelRole, label_observations_add);

        plainTextEdit_obs_add = new QPlainTextEdit(addFormFrame);
        plainTextEdit_obs_add->setObjectName("plainTextEdit_obs_add");

        addFormLayout->setWidget(6, QFormLayout::FieldRole, plainTextEdit_obs_add);

        label_espaceReste_add = new QLabel(addFormFrame);
        label_espaceReste_add->setObjectName("label_espaceReste_add");

        addFormLayout->setWidget(7, QFormLayout::LabelRole, label_espaceReste_add);

        lineEdit_espaceReste_add = new QLineEdit(addFormFrame);
        lineEdit_espaceReste_add->setObjectName("lineEdit_espaceReste_add");

        addFormLayout->setWidget(7, QFormLayout::FieldRole, lineEdit_espaceReste_add);
        ...
        lineEdit_11 = new QLineEdit(modifFormFrame);
        lineEdit_11->setObjectName("lineEdit_11");

        modifFormLayout->setWidget(3, QFormLayout::FieldRole, lineEdit_11);
        ...
        plainTextEdit_5 = new QPlainTextEdit(modifFormFrame);
        plainTextEdit_5->setObjectName("plainTextEdit_5");

        modifFormLayout->setWidget(4, QFormLayout::FieldRole, plainTextEdit_5);
        ...
        label_43 = new QLabel(modifFormFrame);
        label_43->setObjectName("label_43");

        modifFormLayout->setWidget(6, QFormLayout::LabelRole, label_43);

        plainTextEdit_6 = new QPlainTextEdit(modifFormFrame);
        plainTextEdit_6->setObjectName("plainTextEdit_6");

        modifFormLayout->setWidget(6, QFormLayout::FieldRole, plainTextEdit_6);

        label_espaceReste_modif = new QLabel(modifFormFrame);
        label_espaceReste_modif->setObjectName("label_espaceReste_modif");

        modifFormLayout->setWidget(7, QFormLayout::LabelRole, label_espaceReste_modif);

        lineEdit_espaceReste_modif = new QLineEdit(modifFormFrame);
        lineEdit_espaceReste_modif->setObjectName("lineEdit_espaceReste_modif");

        modifFormLayout->setWidget(7, QFormLayout::FieldRole, lineEdit_espaceReste_modif);
...
"    border: none;\n"
"}", nullptr));
        pushButton_3->setText(QCoreApplication::translate("MainWindow", "   EMPLOYE", nullptr));
        ...
        topNavTabs->setTabText(topNavTabs->indexOf(tabAjouter), QCoreApplication::translate("MainWindow", "Ajouter un laboratoire", nullptr));
        topNavTabs->setTabText(topNavTabs->indexOf(tabGestion), QCoreApplication::translate("MainWindow", "Liste des laboratoires", nullptr));
        topNavTabs->setTabText(topNavTabs->indexOf(tabSupprimer), QCoreApplication::translate("MainWindow", "Supprimer un laboratoire", nullptr));
        topNavTabs->setTabText(topNavTabs->indexOf(tabModifier), QCoreApplication::translate("MainWindow", "Modifier un laboratoire", nullptr));
        topNavTabs->setTabText(topNavTabs->indexOf(tabStatistique), QCoreApplication::translate("MainWindow", "Statistiques", nullptr));
        geoPlaceholder->setText(QCoreApplication::translate("MainWindow", "Page de geolocalisation des laboratoires", nullptr));
        topNavTabs->setTabText(topNavTabs->indexOf(tabGeolocalisation), QCoreApplication::translate("MainWindow", "Geolocalisation", nullptr));
        aiPlaceholder->setText(QCoreApplication::translate("MainWindow", "Assistant IA - Chatbot intelligent", nullptr));
        topNavTabs->setTabText(topNavTabs->indexOf(tabAIBot), QCoreApplication::translate("MainWindow", "Assistant IA", nullptr));
        lineEdit->setPlaceholderText(QCoreApplication::translate("MainWindow", "recherche des laboratoires par ID, NOM, adresse, type d analyse ...", nullptr));
        ...
        label_7->setText(QCoreApplication::translate("MainWindow", "   Tri des laboratoires", nullptr));
        ...
        comboBox_2->setItemText(1, QCoreApplication::translate("MainWindow", "Type d analyse", nullptr));
        comboBox_2->setItemText(2, QCoreApplication::translate("MainWindow", "ID", nullptr));
        comboBox_2->setItemText(3, QCoreApplication::translate("MainWindow", "Conformite", nullptr));
        comboBox_2->setItemText(4, QCoreApplication::translate("MainWindow", "Date", nullptr));

        checkBox_3->setText(QCoreApplication::translate("MainWindow", "Croissant", nullptr));
        checkBox_4->setText(QCoreApplication::translate("MainWindow", "Decroissant", nullptr));
        ...
        ___qtablewidgetitem->setText(QCoreApplication::translate("MainWindow", "ID Laboratoire", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidget->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QCoreApplication::translate("MainWindow", "Nom", nullptr));
        QTableWidgetItem *___qtablewidgetitem2 = tableWidget->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QCoreApplication::translate("MainWindow", "Type d analyse", nullptr));
        QTableWidgetItem *___qtablewidgetitem3 = tableWidget->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QCoreApplication::translate("MainWindow", "Conformite", nullptr));
        QTableWidgetItem *___qtablewidgetitem4 = tableWidget->horizontalHeaderItem(4);
        ___qtablewidgetitem4->setText(QCoreApplication::translate("MainWindow", "Adresse", nullptr));
        QTableWidgetItem *___qtablewidgetitem5 = tableWidget->horizontalHeaderItem(5);
        ___qtablewidgetitem5->setText(QCoreApplication::translate("MainWindow", "Espace", nullptr));
        statTitle->setText(QCoreApplication::translate("MainWindow", "Statistiques et Performance des laboratoires", nullptr));
        performanceGroup->setTitle(QCoreApplication::translate("MainWindow", "Taux de conformite", nullptr));
        plainTextEdit->setPlaceholderText(QCoreApplication::translate("MainWindow", "Statistiques de conformite des analyses...", nullptr));
        vitesseGroup->setTitle(QCoreApplication::translate("MainWindow", "Analyses mensuelles", nullptr));
        plainTextEdit_2->setPlaceholderText(QCoreApplication::translate("MainWindow", "Nombre d analyses par mois...", nullptr));
        objectifsGroup->setTitle(QCoreApplication::translate("MainWindow", "Rapports qualite", nullptr));

        const bool __sortingEnabled = listWidget_2->isSortingEnabled();
        listWidget_2->setSortingEnabled(false);
        QListWidgetItem *___qlistwidgetitem = listWidget_2->item(0);
        ___qlistwidgetitem->setText(QCoreApplication::translate("MainWindow", "Certificats qualite disponibles", nullptr));
        listWidget_2->setSortingEnabled(__sortingEnabled);

        evalGroup->setTitle(QCoreApplication::translate("MainWindow", "Observations & Notes", nullptr));
        plainTextEdit_3->setPlaceholderText(QCoreApplication::translate("MainWindow", "Observations et notes qualite...", nullptr));
        ...
        label_17->setText(QCoreApplication::translate("MainWindow", "Recommandations d amelioration", nullptr));
        pushButton_29->setText(QCoreApplication::translate("MainWindow", "RECHERCHER", nullptr));
        checkBox_5->setText(QCoreApplication::translate("MainWindow", "necessite renovation", nullptr));
        label_18->setText(QCoreApplication::translate("MainWindow", "type d analyse:", nullptr));
        comboBox_3->setItemText(0, QCoreApplication::translate("MainWindow", "selectionner le type d analyse", nullptr));
        comboBox_3->setItemText(1, QCoreApplication::translate("MainWindow", "chimique", nullptr));
        comboBox_3->setItemText(2, QCoreApplication::translate("MainWindow", "bacteriologique", nullptr));
        comboBox_3->setItemText(3, QCoreApplication::translate("MainWindow", "physique", nullptr));
        comboBox_3->setItemText(4, QCoreApplication::translate("MainWindow", "biologique", nullptr));

        label_19->setText(QCoreApplication::translate("MainWindow", "espace disponible minimum (m2) :", nullptr));
        lineEdit_3->setPlaceholderText(QCoreApplication::translate("MainWindow", "Entrer l espace minimum ici", nullptr));
        checkBox_7->setText(QCoreApplication::translate("MainWindow", "urgent", nullptr));
        checkBox_8->setText(QCoreApplication::translate("MainWindow", "programme", nullptr));
        label_24->setText(QCoreApplication::translate("MainWindow", "priorite :", nullptr));
        ...
        ___qlistwidgetitem1->setText(QCoreApplication::translate("MainWindow", "Recommandations d amelioration affichees ici", nullptr));
        listWidget_3->setSortingEnabled(__sortingEnabled1);

        label_25->setText(QCoreApplication::translate("MainWindow", "Recommandations", nullptr));
        comboBox_5->setItemText(0, QCoreApplication::translate("MainWindow", "selectionner la priorite", nullptr));
        comboBox_5->setItemText(1, QCoreApplication::translate("MainWindow", "faible", nullptr));
        comboBox_5->setItemText(2, QCoreApplication::translate("MainWindow", "moyenne", nullptr));
        comboBox_5->setItemText(3, QCoreApplication::translate("MainWindow", "haute", nullptr));
        comboBox_5->setItemText(4, QCoreApplication::translate("MainWindow", "critique", nullptr));

        addTitle->setText(QCoreApplication::translate("MainWindow", "Ajouter un Laboratoire", nullptr));
        label_30->setText(QCoreApplication::translate("MainWindow", "Nom:", nullptr));
        lineEdit_5->setPlaceholderText(QCoreApplication::translate("MainWindow", "Entrez le nom du laboratoire", nullptr));
        label_31->setText(QCoreApplication::translate("MainWindow", "Adresse:", nullptr));
        lineEdit_6->setPlaceholderText(QCoreApplication::translate("MainWindow", "Saisissez l adresse complete", nullptr));
        label_32->setText(QCoreApplication::translate("MainWindow", "Type d analyse:", nullptr));
        comboBox_7->setItemText(0, QCoreApplication::translate("MainWindow", "Selectionner le type", nullptr));
        comboBox_7->setItemText(1, QCoreApplication::translate("MainWindow", "Chimique", nullptr));
        comboBox_7->setItemText(2, QCoreApplication::translate("MainWindow", "Bacteriologique", nullptr));
        comboBox_7->setItemText(3, QCoreApplication::translate("MainWindow", "Physique", nullptr));
        comboBox_7->setItemText(4, QCoreApplication::translate("MainWindow", "Biologique", nullptr));

        label_33->setText(QCoreApplication::translate("MainWindow", "Espace total (m2):", nullptr));
        lineEdit_10->setPlaceholderText(QCoreApplication::translate("MainWindow", "Surface totale en m2", nullptr));
        label_34->setText(QCoreApplication::translate("MainWindow", "Resultats:", nullptr));
        plainTextEdit_4->setPlaceholderText(QCoreApplication::translate("MainWindow", "Resultats d analyses...", nullptr));
        label_41->setText(QCoreApplication::translate("MainWindow", "Conformite:", nullptr));
        comboBox_13->setItemText(0, QCoreApplication::translate("MainWindow", "Oui", nullptr));
        comboBox_13->setItemText(1, QCoreApplication::translate("MainWindow", "Non", nullptr));

        label_observations_add->setText(QCoreApplication::translate("MainWindow", "Observations:", nullptr));
        plainTextEdit_obs_add->setPlaceholderText(QCoreApplication::translate("MainWindow", "Observations qualite...", nullptr));
        label_espaceReste_add->setText(QCoreApplication::translate("MainWindow", "Espace reste (m2):", nullptr));
        lineEdit_espaceReste_add->setPlaceholderText(QCoreApplication::translate("MainWindow", "Espace restant en m2", nullptr));

        pushButton_28->setText(QCoreApplication::translate("MainWindow", "Enregistrer", nullptr));
        modifTitle->setText(QCoreApplication::translate("MainWindow", "Modifier un Laboratoire", nullptr));
        ...
        lineEdit_8->setPlaceholderText(QCoreApplication::translate("MainWindow", "Saisissez la nouvelle adresse", nullptr));
        label_37->setText(QCoreApplication::translate("MainWindow", "Type d analyse:", nullptr));
        comboBox_9->setItemText(0, QCoreApplication::translate("MainWindow", "Selectionner le type", nullptr));
        comboBox_9->setItemText(1, QCoreApplication::translate("MainWindow", "Chimique", nullptr));
        comboBox_9->setItemText(2, QCoreApplication::translate("MainWindow", "Bacteriologique", nullptr));
        comboBox_9->setItemText(3, QCoreApplication::translate("MainWindow", "Physique", nullptr));
        comboBox_9->setItemText(4, QCoreApplication::translate("MainWindow", "Biologique", nullptr));

        label_38->setText(QCoreApplication::translate("MainWindow", "Espace total (m2):", nullptr));
        lineEdit_11->setPlaceholderText(QCoreApplication::translate("MainWindow", "Nouvelle surface totale", nullptr));
        label_39->setText(QCoreApplication::translate("MainWindow", "Resultats:", nullptr));
        plainTextEdit_5->setPlaceholderText(QCoreApplication::translate("MainWindow", "Nouveaux resultats...", nullptr));
        label_40->setText(QCoreApplication::translate("MainWindow", "Conformite:", nullptr));
        comboBox_12->setItemText(0, QCoreApplication::translate("MainWindow", "Oui", nullptr));
        comboBox_12->setItemText(1, QCoreApplication::translate("MainWindow", "Non", nullptr));

        label_43->setText(QCoreApplication::translate("MainWindow", "Observations:", nullptr));
        plainTextEdit_6->setPlaceholderText(QCoreApplication::translate("MainWindow", "Observations qualite...", nullptr));
        label_espaceReste_modif->setText(QCoreApplication::translate("MainWindow", "Espace reste (m2):", nullptr));
        lineEdit_espaceReste_modif->setPlaceholderText(QCoreApplication::translate("MainWindow", "Espace restant en m2", nullptr));

        pushButton_34->setText(QCoreApplication::translate("MainWindow", "Modifier", nullptr));
        suppTitle->setText(QCoreApplication::translate("MainWindow", "Supprimer un Laboratoire", nullptr));
        suppWarning->setText(QCoreApplication::translate("MainWindow", "Attention: Cette action est irreversible", nullptr));
        label_42->setText(QCoreApplication::translate("MainWindow", "ID:", nullptr));
        lineEdit_9->setPlaceholderText(QCoreApplication::translate("MainWindow", "Saisissez l ID du laboratoire a supprimer", nullptr));
