...
// ==================== MaterielWidget ====================
MaterielWidget::MaterielWidget(QWidget *parent)
    : QMainWindow(parent)
    , ui(new Ui::MaterielWidget)
{
    ui->setupUi(this);
...
MaterielWidget::~MaterielWidget()
{
    delete ui;
}

void MaterielWidget::initialiserTableMachines()
{
...
void MaterielWidget::initialiserTableHistorique()
{
...
void MaterielWidget::initialiserStatistiques()
{
    // Styles des cartes
...
void MaterielWidget::setupConnections()
{
    // ===== CRUD MACHINE =====
    // Connexion depuis l'onglet Détails
    if (ui->btnAddMachineFromDetails) {
        connect(ui->btnAddMachineFromDetails, &QPushButton::clicked, 
                this, &MaterielWidget::ouvrirAjoutMachineDepuisDetails);
    }
    
    // Actions rapides (panneau droit)
    if (ui->btnQuickEdit) {
        connect(ui->btnQuickEdit, &QPushButton::clicked, this, &MaterielWidget::ouvrirModifierMachine);
    }
    
    if (ui->btnQuickDelete) {
        connect(ui->btnQuickDelete, &QPushButton::clicked, this, &MaterielWidget::ouvrirSupprimerMachine);
    }
    
    if (ui->btnReportProblem) {
        connect(ui->btnReportProblem, &QPushButton::clicked, this, &MaterielWidget::ouvrirSignalerPanne);
    }
    
    // ===== SCANNER QR CODE =====
    // Uniquement dans le panneau droit
    if (ui->btnScanQR_RightPanel) {
        connect(ui->btnScanQR_RightPanel, &QPushButton::clicked, this, &MaterielWidget::scannerQR);
    }
    
    // ===== ACTIONS HISTORIQUE =====
    if (ui->btnAddIntervention) {
        connect(ui->btnAddIntervention, &QPushButton::clicked, this, &MaterielWidget::ouvrirAjouterIntervention);
    }
    
    if (ui->btnDeleteIntervention) {
        connect(ui->btnDeleteIntervention, &QPushButton::clicked, this, &MaterielWidget::ouvrirSupprimerIntervention);
    }
    
    if (ui->btnViewDetails) {
        connect(ui->btnViewDetails, &QPushButton::clicked, this, &MaterielWidget::ouvrirVoirDetailsIntervention);
    }
    
    // ===== EXPORT PDF ET ACTUALISER =====
    if (ui->btnExportPDF) {
        connect(ui->btnExportPDF, &QPushButton::clicked, this, &MaterielWidget::exporterPDF);
    }
    
    if (ui->btnRefresh) {
        connect(ui->btnRefresh, &QPushButton::clicked, this, &MaterielWidget::actualiser);
    }
    
    if (ui->btnExportPDF_Historique) {
        connect(ui->btnExportPDF_Historique, &QPushButton::clicked, this, &MaterielWidget::exporterPDF);
    }
    
    if (ui->btnRefresh_Historique) {
        connect(ui->btnRefresh_Historique, &QPushButton::clicked, this, &MaterielWidget::actualiser);
    }
    
    if (ui->btnExportPDF_Stats) {
        connect(ui->btnExportPDF_Stats, &QPushButton::clicked, this, &MaterielWidget::exporterPDF);
    }
    
    if (ui->btnRefresh_Stats) {
        connect(ui->btnRefresh_Stats, &QPushButton::clicked, this, &MaterielWidget::actualiser);
    }
    
    // ===== ÉVÉNEMENTS =====
    connect(ui->tableEquipments, &QTableWidget::itemSelectionChanged, 
            this, &MaterielWidget::onTableMachineSelectionChanged);
    
    connect(ui->tableHistorique, &QTableWidget::itemSelectionChanged, 
            this, &MaterielWidget::onTableHistoriqueSelectionChanged);
}

void MaterielWidget::ajouterMachinesDemo()
{
...
void MaterielWidget::ajouterInterventionsDemo()
{
...
void MaterielWidget::ouvrirAjoutMachine()
{
...
void MaterielWidget::ouvrirAjoutMachineDepuisDetails()
{
    QMessageBox::information(this, "Simulation", 
...
void MaterielWidget::ouvrirModifierMachine()
{
...
void MaterielWidget::ouvrirSupprimerMachine()
{
    int selectedRow = ui->tableEquipments->currentRow();
    if (selectedRow < 0) {
        QMessageBox::warning(this, "Aucune sélection", 
...
void MaterielWidget::ouvrirSignalerPanne()
{
    int selectedRow = ui->tableEquipments->currentRow();
    QString machineNom;
...
void MaterielWidget::ouvrirAjouterIntervention()
{
    int selectedRow = ui->tableEquipments->currentRow();
    if (selectedRow < 0) {
        QMessageBox::warning(this, "Aucune sélection", 
...
void MaterielWidget::ouvrirSupprimerIntervention()
{
...
void MaterielWidget::ouvrirVoirDetailsIntervention()
{
    int selectedRow = ui->tableHistorique->currentRow();
    if (selectedRow < 0) {
        QMessageBox::warning(this, "Aucune sélection", 
...
void MaterielWidget::exporterPDF()
{
    QMessageBox::information(this, "Simulation", 
...
void MaterielWidget::actualiser()
{
...
void MaterielWidget::onTableMachineSelectionChanged()
{
    int selectedRow = ui->tableEquipments->currentRow();
    if (selectedRow >= 0) {
        QString etat = ui->tableEquipments->item(selectedRow, 5)->text();
...
void MaterielWidget::onTableHistoriqueSelectionChanged()
{
...
void MaterielWidget::mettreAJourStatistiques()
{
...
void MaterielWidget::mettreAJourGraphiqueCategories()
{
...
void MaterielWidget::mettreAJourGraphiqueEtats()
{
...
void MaterielWidget::mettreAJourTendanceInterventions()
{
