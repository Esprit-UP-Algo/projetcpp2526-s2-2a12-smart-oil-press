...
bool Ccommande::ajouter(const Ccommande &cmd)
{
    ...
    qDebug() << "Valeurs : id=" << cmd.getIdCommande()
             << "libelle=" << cmd.getLibelle()
             << "dateArr=" << cmd.getDateArrivage().toString("yyyy-MM-dd")
             << "dateSort=" << cmd.getDateSortie().toString("yyyy-MM-dd")
             << "etat=" << cmd.getEtat()
             << "qte=" << cmd.getQuantite()
             << "montant=" << cmd.getMontantTotal()
             << "idClient=" << cmd.getIdClient();
