...
void setupMachineConnections();
    ...
    void generateMachineHtmlFromLog(int idMachine);
    void generateQRCodeForMachine(int idMachine);
    void onGenerateMachineQRCode();
...
private:
    ...
    // === MODULE PARKING ARDUINO ===
    ParkingWidget *m_parkingWidget = nullptr;
